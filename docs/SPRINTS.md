...
| **S25** | Analytic depth | TBD | Next slot: IV (instrumental variables) estimator, T-/X-learner outcome models for TMLE, or frontend operator cards for S23/S24 sensitivity + disagreement. |

...
Sec-4 (config + middleware hardening, audit triage) shipped 2026-05-23
as PR #25 → `5ae3171`. S23 (sensitivity) + Sec-3 (4 CodeQL alerts)
both landed 2026-05-22.
...
Last updated 2026-05-23 — **Sec-4 (5 config + middleware hardening fixes from Copilot audit triage)** shipped to `main` as PR #25 → `5ae3171`. Previous (same week): S23 sensitivity + Sec-3 (4 CodeQL alerts) on 2026-05-22; S20.1 deferred-integration arc closure; Sec-2 (42 CodeQL findings).

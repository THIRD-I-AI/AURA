...
- **Status:** partially fixed — items 1 and 6 fixed 2026-09-02; items 2-3, 5, 7 remain open (deferred); item 4 not yet picked up.
...
- **Fix:** items 1 and 6 fixed (see above). Items 2-3 have the same "currently unreachable service" mitigation as BUG-010's items 2 and 4 — low priority. Item 4 is a one-token nit, pick up opportunistically. Items 5 and 7 are larger refactors (component-splitting), deliberately out of scope for a surgical fix.

...
class Client:
    """Auto-generated typed HTTP client for ``aura_causal_client``.
    ...
    def causal_discover_causal_discover(self, body: "CausalDiscoverRequest") -> "CausalDiscoverResponse":
        """Causal Discover"""
        url = "/causal/discover"
        params = None
        ...
        from .models import CausalDiscoverResponse
        return CausalDiscoverResponse.model_validate(response)

    def causal_info_causal_info(self) -> Dict[str, Any]:
        """Causal Info"""
        url = "/causal/info"
        params = None
        json_body = None
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_causal_client``.
    ...
    async def causal_discover_causal_discover(self, body: "CausalDiscoverRequest") -> "CausalDiscoverResponse":
        """Causal Discover"""
        url = "/causal/discover"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def causal_info_causal_info(self) -> Dict[str, Any]:
        """Causal Info"""
        url = "/causal/info"
        params = None
        json_body = None

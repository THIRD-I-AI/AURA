...
class Client:
    """Auto-generated typed HTTP client for ``aura_ingestion_client``.
    ...
    def get_erc_mapping(self, erc: str, system: Optional[str] = None) -> Dict[str, Any]:
        """Get Erc Mapping"""
        url = f"/api/v1/ingest/erc-map/{erc}".format(erc=erc)
        params = {
            "system": system,
        }
    ...
    def ingest_netsuite_batch(self, body: "RawIngestionPayload") -> Dict[str, Any]:
        """Ingest Netsuite Batch"""
        url = "/api/v1/ingest/netsuite"
        params = None
    ...
    def ingest_workday_batch(self, body: "RawIngestionPayload") -> Dict[str, Any]:
        """Ingest Workday Batch"""
        url = "/api/v1/ingest/workday"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
        response = self._request("POST", url, params=params, json=json_body)
        return response
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_ingestion_client``.
    ...
    async def get_erc_mapping(self, erc: str, system: Optional[str] = None) -> Dict[str, Any]:
        """Get Erc Mapping"""
        url = f"/api/v1/ingest/erc-map/{erc}".format(erc=erc)
        params = {
            "system": system,
    ...
    async def ingest_netsuite_batch(self, body: "RawIngestionPayload") -> Dict[str, Any]:
        """Ingest Netsuite Batch"""
        url = "/api/v1/ingest/netsuite"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def ingest_workday_batch(self, body: "RawIngestionPayload") -> Dict[str, Any]:
        """Ingest Workday Batch"""
        url = "/api/v1/ingest/workday"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body

...
class Client:
    """Auto-generated typed HTTP client for ``aura_insights_client``.
    ...
    def analyze_results_analyze(self, body: "AnalyzeRequest") -> "AnalyzeResponse":
        """Analyze Results"""
        url = "/analyze"
        params = None
    ...
    def recommend_indexes_recommend_indexes(self, body: "RecommendIndexesRequest") -> Dict[str, Any]:
        """Recommend Indexes"""
        url = "/recommend-indexes"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
        response = self._request("POST", url, params=params, json=json_body)
        return response

    def suggest_charts_chart_suggestions(self, body: "ChartSuggestionRequest") -> "ChartSuggestionResponse":
        """Suggest Charts"""
        url = "/chart-suggestions"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
        response = self._request("POST", url, params=params, json=json_body)
        from .models import ChartSuggestionResponse
        return ChartSuggestionResponse.model_validate(response)

# ── AsyncClient — async mirror of Client ──────────────────────────────

class AsyncClient:
    """Auto-generated async HTTP client for ``aura_insights_client``.
    ...
    async def analyze_results_analyze(self, body: "AnalyzeRequest") -> "AnalyzeResponse":
        """Analyze Results"""
        url = "/analyze"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def recommend_indexes_recommend_indexes(self, body: "RecommendIndexesRequest") -> Dict[str, Any]:
        """Recommend Indexes"""
        url = "/recommend-indexes"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def suggest_charts_chart_suggestions(self, body: "ChartSuggestionRequest") -> "ChartSuggestionResponse":
        """Suggest Charts"""
        url = "/chart-suggestions"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body

...
class Client:
    """Auto-generated typed HTTP client for ``aura_code_generation_client``.
    ...
    def generate_code_generate_code(self, body: "PlanStep") -> Dict[str, Any]:
        """Generate Code"""
        url = "/generate_code"
        params = None
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_code_generation_client``.
    ...
    async def generate_code_generate_code(self, body: "PlanStep") -> Dict[str, Any]:
        """Generate Code"""
        url = "/generate_code"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body

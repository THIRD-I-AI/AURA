...
class Client:
    """Auto-generated typed HTTP client for ``aura_dar_client``.
    ...
    def daemon_start_dar_daemon_start(self) -> Dict[str, Any]:
        """Daemon Start"""
        url = "/dar/daemon/start"
        params = None
        json_body = None
        response = self._request("POST", url, params=params, json=json_body)
        return response

    def daemon_status_dar_daemon_status(self) -> Dict[str, Any]:
        """Daemon Status"""
        url = "/dar/daemon/status"
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        return response

    def daemon_stop_dar_daemon_stop(self) -> Dict[str, Any]:
        """Daemon Stop"""
        url = "/dar/daemon/stop"
        params = None
        json_body = None
    ...
    def get_insight_dar_insights__insight_id_(self, insight_id: str) -> "InsightOut":
        """Get Insight"""
        url = f"/dar/insights/{insight_id}".format(insight_id=insight_id)
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        from .models import InsightOut
        return InsightOut.model_validate(response)
    ...
    def list_insights_dar_insights(self, table: Optional[str] = None, source: Optional[str] = None, finding_type: Optional[str] = None, min_score: Optional[float] = None, anomalies_only: Optional[bool] = None, limit: Optional[int] = None) -> Dict[str, Any]:
        """List Insights"""
        url = "/dar/insights"
        params = {
            "table": table,
    ...
    def trigger_research_run_dar_research_run(self, body: "ResearchRunRequest") -> Dict[str, Any]:
        """Trigger Research Run"""
        url = "/dar/research/run"
        params = None
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_dar_client``.
    ...
    async def daemon_start_dar_daemon_start(self) -> Dict[str, Any]:
        """Daemon Start"""
        url = "/dar/daemon/start"
        params = None
        json_body = None
    ...
    async def daemon_status_dar_daemon_status(self) -> Dict[str, Any]:
        """Daemon Status"""
        url = "/dar/daemon/status"
        params = None
        json_body = None
    ...
    async def daemon_stop_dar_daemon_stop(self) -> Dict[str, Any]:
        """Daemon Stop"""
        url = "/dar/daemon/stop"
        params = None
        json_body = None
    ...
    async def get_insight_dar_insights__insight_id_(self, insight_id: str) -> "InsightOut":
        """Get Insight"""
        url = f"/dar/insights/{insight_id}".format(insight_id=insight_id)
        params = None
        json_body = None
    ...
    async def list_insights_dar_insights(self, table: Optional[str] = None, source: Optional[str] = None, finding_type: Optional[str] = None, min_score: Optional[float] = None, anomalies_only: Optional[bool] = None, limit: Optional[int] = None) -> Dict[str, Any]:
        """List Insights"""
        url = "/dar/insights"
        params = {
            "table": table,
    ...
    async def trigger_research_run_dar_research_run(self, body: "ResearchRunRequest") -> Dict[str, Any]:
        """Trigger Research Run"""
        url = "/dar/research/run"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body

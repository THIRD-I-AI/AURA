...
class Client:
    """Auto-generated typed HTTP client for ``aura_metadata_store_client``.
    ...
    def get_dataset_profile_dataset_profiles__file_id_(self, file_id: str) -> Dict[str, Any]:
        """Get Dataset Profile"""
        url = f"/dataset-profiles/{file_id}".format(file_id=file_id)
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        return response

    def get_semantic_model_semantic_models__model_id_(self, model_id: str) -> Dict[str, Any]:
        """Get Semantic Model"""
        url = f"/semantic-models/{model_id}".format(model_id=model_id)
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        return response

    def get_user_users__user_id_(self, user_id: str) -> Dict[str, Any]:
        """Get User"""
        url = f"/users/{user_id}".format(user_id=user_id)
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        return response
    ...
    def list_data_sources_data_sources(self) -> Dict[str, Any]:
        """List Data Sources"""
        url = "/data-sources"
        params = None
        json_body = None
    ...
    def list_semantic_models_semantic_models(self) -> Dict[str, Any]:
    ...
    def upsert_dataset_profile_dataset_profiles__file_id_(self, file_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Upsert Dataset Profile"""
        url = f"/dataset-profiles/{file_id}".format(file_id=file_id)
        params = None
        json_body = body
    ...
    def upsert_semantic_model_semantic_models(self, body: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def upsert_user_users__user_id_(self, user_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Upsert User"""
        url = f"/users/{user_id}".format(user_id=user_id)
        params = None
        json_body = body
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_metadata_store_client``.
    ...
    async def get_dataset_profile_dataset_profiles__file_id_(self, file_id: str) -> Dict[str, Any]:
        """Get Dataset Profile"""
        url = f"/dataset-profiles/{file_id}".format(file_id=file_id)
        params = None
        json_body = None
    ...
    async def get_semantic_model_semantic_models__model_id_(self, model_id: str) -> Dict[str, Any]:
        """Get Semantic Model"""
        url = f"/semantic-models/{model_id}".format(model_id=model_id)
        params = None
        json_body = None
    ...
    async def get_user_users__user_id_(self, user_id: str) -> Dict[str, Any]:
        """Get User"""
        url = f"/users/{user_id}".format(user_id=user_id)
        params = None
        json_body = None
    ...
    async def list_data_sources_data_sources(self) -> Dict[str, Any]:
        """List Data Sources"""
        url = "/data-sources"
        params = None
        json_body = None
    ...
    async def list_semantic_models_semantic_models(self) -> Dict[str, Any]:
        """List Semantic Models"""
        url = "/semantic-models"
        params = None
        json_body = None
    ...
    async def upsert_dataset_profile_dataset_profiles__file_id_(self, file_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Upsert Dataset Profile"""
        url = f"/dataset-profiles/{file_id}".format(file_id=file_id)
        params = None
        json_body = body
    ...
    async def upsert_semantic_model_semantic_models(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Upsert Semantic Model"""
        url = "/semantic-models"
        params = None
        json_body = body
    ...
    async def upsert_user_users__user_id_(self, user_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
        """Upsert User"""
        url = f"/users/{user_id}".format(user_id=user_id)
        params = None
        json_body = body

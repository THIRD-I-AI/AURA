...
class Client:
    """Auto-generated typed HTTP client for ``aura_database_client``.
    ...
    def create_connection_connections(self, body: "DatabaseConnectionRequest") -> Dict[str, Any]:
        """Create Connection"""
        url = "/connections"
        params = None
    ...
    def delete_connection_connections__connection_id_(self, connection_id: str) -> Dict[str, Any]:
        """Delete Connection"""
        url = f"/connections/{connection_id}".format(connection_id=connection_id)
        params = None
        json_body = None
        response = self._request("DELETE", url, params=params, json=json_body)
        return response

    def execute_query_connections__connection_id__query(self, connection_id: str, body: "QueryRequest") -> "QueryResponse":
        """Execute Query"""
    ...
    def get_connection_connections__connection_id_(self, connection_id: str) -> "DatabaseConnectionResponse":
        """Get Connection"""
        url = f"/connections/{connection_id}".format(connection_id=connection_id)
        params = None
        json_body = None
        response = self._request("GET", url, params=params, json=json_body)
        from .models import DatabaseConnectionResponse
        return DatabaseConnectionResponse.model_validate(response)

    def get_schema_connections__connection_id__schema(self, connection_id: str, refresh: Optional[bool] = None) -> "SchemaResponse":
        """Get Schema"""
        url = f"/connections/{connection_id}/schema".format(connection_id=connection_id)
        params = {
            "refresh": refresh,
        }
        ...
        return SchemaResponse.model_validate(response)

    def get_supported_databases_supported_databases(self) -> Dict[str, Any]:
    ...
    def health_check_health(self) -> Dict[str, Any]:
        """Health Check"""
        url = "/health"
        params = None
        json_body = None
    ...
    def test_connection_connections__connection_id__test(self, connection_id: str) -> Dict[str, Any]:
        """Test Connection"""
        url = f"/connections/{connection_id}/test".format(connection_id=connection_id)
        params = None
        json_body = None
        response = self._request("POST", url, params=params, json=json_body)
        return response
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_database_client``.
    ...
    async def create_connection_connections(self, body: "DatabaseConnectionRequest") -> Dict[str, Any]:
        """Create Connection"""
        url = "/connections"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def delete_connection_connections__connection_id_(self, connection_id: str) -> Dict[str, Any]:
        """Delete Connection"""
        url = f"/connections/{connection_id}".format(connection_id=connection_id)
        params = None
        json_body = None
    ...
    async def execute_query_connections__connection_id__query(self, connection_id: str, body: "QueryRequest") -> "QueryResponse":
        """Execute Query"""
        url = f"/connections/{connection_id}/query".format(connection_id=connection_id)
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
    ...
    async def get_connection_connections__connection_id_(self, connection_id: str) -> "DatabaseConnectionResponse":
        """Get Connection"""
        url = f"/connections/{connection_id}".format(connection_id=connection_id)
        params = None
        json_body = None
    ...
    async def get_schema_connections__connection_id__schema(self, connection_id: str, refresh: Optional[bool] = None) -> "SchemaResponse":
        """Get Schema"""
        url = f"/connections/{connection_id}/schema".format(connection_id=connection_id)
        params = {
            "refresh": refresh,
    ...
    async def get_supported_databases_supported_databases(self) -> Dict[str, Any]:
        """Get Supported Databases"""
        url = "/supported-databases"
        params = None
        json_body = None
    ...
    async def health_check_health(self) -> Dict[str, Any]:
        """Health Check"""
        url = "/health"
        params = None
        json_body = None
    ...
    async def test_connection_connections__connection_id__test(self, connection_id: str) -> Dict[str, Any]:
        """Test Connection"""
        url = f"/connections/{connection_id}/test".format(connection_id=connection_id)
        params = None
        json_body = None

# aura_knowledge_base_client

Auto-generated SDK package for the **knowledge-base** service.
...
python scripts/generate_sdk.py \
    ...
    --output sdk_clients/aura_knowledge_base_client \
    --package-name aura_knowledge_base_client \
    --service-tag knowledge-base
```
...
Generated from 2 component schemas. The codegen tool

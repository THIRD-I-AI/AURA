...
class Client:
    """Auto-generated typed HTTP client for ``aura_knowledge_base_client``.
    ...
    def get_schema_schemas__table_name_(self, table_name: str) -> Dict[str, Any]:
        """Get Schema"""
        url = f"/schemas/{table_name}".format(table_name=table_name)
        params = None
        json_body = None
    ...
    def ingest_document_ingest(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Ingest Document"""
        url = "/ingest"
        params = None
        json_body = body
    ...
    def search_documents_search(self, q: Optional[str] = None, limit: Optional[int] = None) -> Dict[str, Any]:
        """Search Documents"""
        url = "/search"
        params = {
            "q": q,
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_knowledge_base_client``.
    ...
    async def get_schema_schemas__table_name_(self, table_name: str) -> Dict[str, Any]:
        """Get Schema"""
        url = f"/schemas/{table_name}".format(table_name=table_name)
        params = None
        json_body = None
    ...
    async def ingest_document_ingest(self, body: Dict[str, Any]) -> Dict[str, Any]:
        """Ingest Document"""
        url = "/ingest"
        params = None
        json_body = body
    ...
    async def search_documents_search(self, q: Optional[str] = None, limit: Optional[int] = None) -> Dict[str, Any]:
        """Search Documents"""
        url = "/search"
        params = {
            "q": q,

...
class Client:
    """Auto-generated typed HTTP client for ``aura_execution_sandbox_client``.
    ...
    def execute_sql_execute_sql(self, body: "ExecutionJob") -> "QueryResult":
        """Execute Sql"""
        url = "/execute_sql"
        params = None
...
class AsyncClient:
    """Auto-generated async HTTP client for ``aura_execution_sandbox_client``.
    ...
    async def execute_sql_execute_sql(self, body: "ExecutionJob") -> "QueryResult":
        """Execute Sql"""
        url = "/execute_sql"
        params = None
        json_body = body.model_dump(mode='json') if hasattr(body, 'model_dump') else body
